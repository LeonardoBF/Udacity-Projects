...
Projeto de aprendizagem supervisionada, desenvolvido no Nanodegree de Data Scientist da Udacity, cujo objetivo é treinar um modelo capaz de prever pessoas com maior probabilidade (renda superior a $50.000) de realizar uma doação à entidade.
